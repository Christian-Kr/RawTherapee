...
Retinex::Retinex () : FoldableToolPanel (this, TOOL_NAME, M ("TP_RETINEX_LABEL"), false, true), lastmedianmap (false)
{
    ...
    setExpandAlignProperties (retinexGrid, false, false, Gtk::Align::FILL, Gtk::ALIGN_START);

    dhgrid = Gtk::manage (new Gtk::Grid ());
    setExpandAlignProperties (dhgrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
//  retinexMethod->append (M("TP_RETINEX_HIGHLIGPLUS"));
    ...
    setExpandAlignProperties (str, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    retinexGrid->attach (*str, 0, 1, 1, 1);
    str->show ();

    neigh = Gtk::manage (new Adjuster (M ("TP_RETINEX_NEIGHBOR"), 6, 100., 1., 80.));
    setExpandAlignProperties (neigh, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    retinexGrid->attach (*neigh, 0, 2, 1, 1);
    neigh->show ();

    vart   = Gtk::manage (new Adjuster (M ("TP_RETINEX_VARIANCE"), 50, 500, 1, 200));
    setExpandAlignProperties (vart, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (highl, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    highl->set_tooltip_markup (M ("TP_RETINEX_HIGHLIGHT_TOOLTIP"));
    retinexGrid->attach (*highl, 0, 4, 1, 1);
    highl->show ();

    viewgrid = Gtk::manage (new Gtk::Grid ());
    setExpandAlignProperties (viewgrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
 ...
 //   Gtk::Frame *maskFrame = Gtk::manage (new Gtk::Frame (M ("TP_RETINEX_LABEL_MASK")) );
    ...
    setExpandAlignProperties (maskFrame, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);

    Gtk::Grid *maskGrid = Gtk::manage ( new Gtk::Grid());
    setExpandAlignProperties (maskGrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);

    // Map Method
    mapgrid = Gtk::manage (new Gtk::Grid ());
    setExpandAlignProperties (mapgrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (curveEditormap, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (settingsGrid, false, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (equalFrame, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
//GTK318
...
//GTK318
    ...
    setExpandAlignProperties (equalGrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);

    // Histogram equalizer Lab curve
    curveEditorGD = new CurveEditorGroup (options.lastRetinexDir, M ("TP_RETINEX_CONTEDIT_LAB"));
    setExpandAlignProperties (curveEditorGD, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (curveEditorGDH, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (curveEditorGH, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (gamgrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (gam, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    equalGrid->attach (*gam, 0, 4, 1, 1);
    gam->show ();

    slope = Gtk::manage (new Adjuster (M ("TP_RETINEX_SLOPE"), 1., 20., 0.1, 3.));
    setExpandAlignProperties (slope, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (iterFrame, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
//GTK318
#if GTK_MAJOR_VERSION == 3 && GTK_MINOR_VERSION < 20
...
//GTK318
    ...
    setExpandAlignProperties (iterGrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);

    iter   = Gtk::manage (new Adjuster (M ("TP_RETINEX_ITER"), 1, 5., 1., 1.));
    setExpandAlignProperties (iter, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (scal, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (grad, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (grads, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (tranFrame, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
//GTK318
#if GTK_MAJOR_VERSION == 3 && GTK_MINOR_VERSION < 20
...
//GTK318
    ...
    setExpandAlignProperties (tranGrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);


    // Transmission map curve
    transmissionCurveEditorG = new CurveEditorGroup (options.lastRetinexDir, M ("TP_RETINEX_TRANSMISSION"));
    setExpandAlignProperties (transmissionCurveEditorG, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (skal, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    tranGrid->attach (*skal, 0, 1, 1, 1);
    skal->show ();

    // Threshold
    limd = Gtk::manage (new Adjuster (M ("TP_RETINEX_THRESHOLD"), 2, 100, 1, 8));
    setExpandAlignProperties (limd, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (medianmap, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (gainFrame, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
//GTK318
#if GTK_MAJOR_VERSION == 3 && GTK_MINOR_VERSION < 20
...
//GTK318
    ...
    setExpandAlignProperties (gainGrid, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (gaintransmissionCurve, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (offs, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
