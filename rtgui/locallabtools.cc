    ...
    complexity(Gtk::manage(new MyComboBoxText()))
{
    ...
    exp = Gtk::manage(new RTExpander(true, titVBox));
...
LocallabColor::LocallabColor():
    ...
    exprecov(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expgradcol(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_EXPGRAD")))),
...
//    fatFrame(Gtk::manage(new Gtk::Frame(M("TP_LOCALLAB_FATFRA")))),
    ...
    exptoolexp(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_EXPTOOL")))),
    ...
    exprecove(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expgradexp(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_EXPGRAD")))),
...
LocallabShadow::LocallabShadow():
    ...
    exprecovs(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expgradsh(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_EXPGRAD")))),
...
LocallabVibrance::LocallabVibrance():
    ...
    exprecovv(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expgradvib(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_EXPGRAD")))),
...
LocallabBlur::LocallabBlur():
    ...
    expdenoise2(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
  ...
  //  lCLabels(Gtk::manage(new Gtk::Label(M("TP_LOCALLAB_LCLABELS")))),
    ...
    expdenoise1(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI1_EXP")))),
    ...
    expdenoise3(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
