...
ZoomPanel::ZoomPanel (ImageArea* iarea) : iarea(iarea)
{
    ...
    setExpandAlignProperties(zoomOut, false, false, Gtk::ALIGN_CENTER, Gtk::Align::FILL);
    zoomIn = Gtk::manage (new Gtk::Button());
    zoomIn->add (*imageIn);
    zoomIn->set_relief(Gtk::RELIEF_NONE);
    setExpandAlignProperties(zoomIn, false, false, Gtk::ALIGN_CENTER, Gtk::Align::FILL);
    zoomFit = Gtk::manage (new Gtk::Button());
    zoomFit->add (*imageFit);
    zoomFit->set_relief(Gtk::RELIEF_NONE);
    setExpandAlignProperties(zoomFit, false, false, Gtk::ALIGN_CENTER, Gtk::Align::FILL);
    zoomFitCrop = Gtk::manage (new Gtk::Button());
    zoomFitCrop->add (*imageFitCrop);
    zoomFitCrop->set_relief(Gtk::RELIEF_NONE);
    setExpandAlignProperties(zoomFitCrop, false, false, Gtk::ALIGN_CENTER, Gtk::Align::FILL);
    zoom11 = Gtk::manage (new Gtk::Button());
    zoom11->add (*image11);
    zoom11->set_relief(Gtk::RELIEF_NONE);
    setExpandAlignProperties(zoom11, false, false, Gtk::ALIGN_CENTER, Gtk::Align::FILL);
    ...
    setExpandAlignProperties(zoomLabel, false, false, Gtk::ALIGN_CENTER, Gtk::Align::FILL);
    ...
    setExpandAlignProperties(newCrop, false, false, Gtk::ALIGN_CENTER, Gtk::Align::FILL);
