...
SaveFormatPanel::SaveFormatPanel () : listener (nullptr)
{
    ...
    setExpandAlignProperties(jpegOpts, true, false, Gtk::Align::FILL, Gtk::ALIGN_CENTER);

    jpegQual = Gtk::manage (new Adjuster (M("SAVEDLG_JPEGQUAL"), 0, 100, 1, 100) );
    setExpandAlignProperties(jpegQual, true, false, Gtk::Align::FILL, Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(tiffUncompressed, true, false, Gtk::Align::FILL, Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(bigTiff, true, false, Gtk::Align::FILL, Gtk::ALIGN_CENTER);
