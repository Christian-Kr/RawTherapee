...
LocallabTone::LocallabTone():
    ...
    exprecovt(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expmasktm(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_SHOWT")))),
    showmasktmMethod(Gtk::manage(new Gtk::ComboBoxText())),
    ...
    Lmasktmshape(static_cast<DiagonalCurveEditor*>(mask2tmCurveEditorG->addCurve(CT_Diagonal, "L(L)")))
{
    ...
    setExpandAlignProperties(exprecovt, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);

    setExpandAlignProperties(expmasktm, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
LocallabRetinex::LocallabRetinex():
    ...
    expretitools(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_EXPRETITOOLS")))),
    ...
    exprecovr(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expmaskreti(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_SHOWR")))),
    showmaskretiMethod(Gtk::manage(new Gtk::ComboBoxText())),
    ...
    inversret(Gtk::manage(new Gtk::CheckButton(M("TP_LOCALLAB_INVERS"))))
{
    ...
    setExpandAlignProperties(expretitools, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(exprecovr, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);

    setExpandAlignProperties(expmaskreti, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
LocallabSharp::LocallabSharp():
    ...
    showmasksharMethod(Gtk::manage(new Gtk::ComboBoxText()))
{
    set_orientation(Gtk::Orientation::VERTICAL);
...
LocallabContrast::LocallabContrast():
    ...
    localcontMethod(Gtk::manage(new Gtk::ComboBoxText())),
    ...
    expresidpyr(Gtk::manage(new RTExpander(false, Gtk::manage(new Gtk::Box())))),
    ...
    expcontrastpyr(Gtk::manage(new RTExpander(false, Gtk::manage(new Gtk::Box())))),
    ...
    localedgMethod(Gtk::manage(new Gtk::ComboBoxText())),
    ...
    localneiMethod(Gtk::manage(new Gtk::ComboBoxText())),
    ...
    expcontrastpyr2(Gtk::manage(new RTExpander(false, Gtk::manage(new Gtk::Box())))),
    ...
    exprecovw(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expmasklc(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_SHOWLC")))),
    showmasklcMethod(Gtk::manage(new Gtk::ComboBoxText())),
...
//    wavshape->setBottomBarBgGradient({{0., 0., 0., 0.}, {1., 1., 1., 1.}});
    ...
    setExpandAlignProperties(expresidpyr, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(expcontrastpyr, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
//    wavshapeedg->setBottomBarBgGradient({{0., 0., 0., 0.}, {1., 1., 1., 1.}});
    ...
    setExpandAlignProperties(expcontrastpyr2, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
//    wavshapecomp->setBottomBarBgGradient({{0., 0., 0., 0.}, {1., 1., 1., 1.}});
    ...
    setExpandAlignProperties(exprecovw, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);


    setExpandAlignProperties(expmasklc, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
LocallabCBDL::LocallabCBDL():
    ...
    exprecovcb(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expmaskcb(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_SHOWCB")))),
    showmaskcbMethod(Gtk::manage(new Gtk::ComboBoxText())),
    ...
    lumacontrastPlusButton(Gtk::manage(new Gtk::Button(M("TP_DIRPYREQUALIZER_LUMACONTRAST_PLUS"))))
{
    ...
    setExpandAlignProperties(exprecovcb, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
LocallabLog::LocallabLog():
    ...
    sursour(Gtk::manage (new Gtk::ComboBoxText ())),
    ...
    expL(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_LOGEXP")))),
    ...
    surround(Gtk::manage (new Gtk::ComboBoxText ())),
    ...
    exprecovl(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expmaskL(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_SHOWC")))),
    showmaskLMethod(Gtk::manage(new Gtk::ComboBoxText())),
    ...
    
{
    ...
    setExpandAlignProperties(expL, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(exprecovl, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(expmaskL, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
LocallabMask::LocallabMask():
    ...
    showmask_Method(Gtk::manage(new Gtk::ComboBoxText())),
...
Locallabcie::Locallabcie():
    ...
    modecam(Gtk::manage (new Gtk::ComboBoxText ())),
    modecie(Gtk::manage (new Gtk::ComboBoxText ())),
    ...
    sursourcie(Gtk::manage (new Gtk::ComboBoxText ())),
    ...
    expjz(Gtk::manage(new RTExpander(false, Gtk::manage(new Gtk::Box())))),
    ...
    expwavjz(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_JZWAVEXP")))),
    ...
    expcam16(Gtk::manage(new RTExpander(false, Gtk::manage(new Gtk::Box())))),
    ...
    toneMethodcie(Gtk::manage(new Gtk::ComboBoxText())),
    ...
    toneMethodcie2(Gtk::manage(new Gtk::ComboBoxText())),
...
*/    
    expLcie(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_CIETOOLEXP")))),
    ...
    surroundcie(Gtk::manage (new Gtk::ComboBoxText ())),
    surrHBoxcie(Gtk::manage(new Gtk::Box())),
    exprecovcie(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_DENOI2_EXP")))),
    ...
    expmaskcie(Gtk::manage(new RTExpander(false, M("TP_LOCALLAB_SHOWS")))),
    showmaskcieMethod(Gtk::manage(new Gtk::ComboBoxText())),
...
//    PQFBox->pack_start(*contthreszcam);
  ...
  //  jzBox->pack_start(*sigmoidjzFrame);
    ...
    setExpandAlignProperties(expjz, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
 ...
 */   
    ...
    setExpandAlignProperties(expwavjz, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(expLcie, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
*/
    ...
    setExpandAlignProperties(expcam16, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
...
//    cieP2Box->pack_start(*jabcie);
    ...
    setExpandAlignProperties(exprecovcie, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);


    setExpandAlignProperties(expmaskcie, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
