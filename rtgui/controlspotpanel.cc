...
ControlSpotPanel::ControlSpotPanel():
    ...
    prevMethod_(Gtk::manage(new Gtk::ComboBoxText())),
    shape_(Gtk::manage(new Gtk::ComboBoxText())),
    spotMethod_(Gtk::manage(new Gtk::ComboBoxText())),
    shapeMethod_(Gtk::manage(new Gtk::ComboBoxText())),
    qualityMethod_(Gtk::manage(new Gtk::ComboBoxText())),
    //complexMethod_(Gtk::manage(new Gtk::ComboBoxText())),
    wavMethod_(Gtk::manage(new Gtk::ComboBoxText())),
    avoidgamutMethod_(Gtk::manage(new Gtk::ComboBoxText())),
