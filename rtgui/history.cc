...
History::History (bool bookmarkSupport) : historyVPaned (nullptr), blistener (nullptr), tpc (nullptr), bmnum (1)
{
    ...
    */
    ...
    setExpandAlignProperties (addBookmark, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties (delBookmark, true, false, Gtk::Align::FILL, Gtk::ALIGN_START);
