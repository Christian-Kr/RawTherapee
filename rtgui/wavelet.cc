...
Wavelet::Wavelet() :
 ...
 //   threshold2(Gtk::manage(new Adjuster(M("TP_WAVELET_THRESHOLD2"), 1, 9, 1, 4))),
    ...
    CHmethod(Gtk::manage(new Gtk::ComboBoxText())),
    CHSLmethod(Gtk::manage(new Gtk::ComboBoxText())),
    EDmethod(Gtk::manage(new Gtk::ComboBoxText())),
    BAmethod(Gtk::manage(new Gtk::ComboBoxText())),
    NPmethod(Gtk::manage(new Gtk::ComboBoxText())),
    TMmethod(Gtk::manage(new Gtk::ComboBoxText())),
    HSmethod(Gtk::manage(new Gtk::ComboBoxText())),
    CLmethod(Gtk::manage(new Gtk::ComboBoxText())),
    Backmethod(Gtk::manage(new Gtk::ComboBoxText())),
    complexmethod(Gtk::manage(new Gtk::ComboBoxText())),
    Tilesmethod(Gtk::manage(new Gtk::ComboBoxText())),
    daubcoeffmethod(Gtk::manage(new Gtk::ComboBoxText())),
    Dirmethod(Gtk::manage(new Gtk::ComboBoxText())),
    Medgreinf(Gtk::manage(new Gtk::ComboBoxText())),
    ushamethod(Gtk::manage(new Gtk::ComboBoxText())),
    //denmethod(Gtk::manage(new Gtk::ComboBoxText())),
    mixmethod(Gtk::manage(new Gtk::ComboBoxText())),
    quamethod(Gtk::manage(new Gtk::ComboBoxText())),
    slimethod(Gtk::manage(new Gtk::ComboBoxText())),
