...
void RTOptions::saveToFile(Glib::ustring fname)
{
    ...
    try {
        ...
        std::vector<Glib::ustring> pext = parseExtensions;
        keyFile->set_string_list("File Browser", "ParseExtensions", pext);
        std::vector<int> pextena = parseExtensionsEnabled;
        ...
        std::vector<Glib::ustring> pfav = favoriteDirs;
        keyFile->set_string_list("File Browser", "FavoriteDirs", pfav);
        std::vector<Glib::ustring> pren = renameTemplates;
        ...
        std::vector<double> ptzoom = thumbnailZoomRatios;
        ...
        std::vector<Glib::ustring> ahfavorites = favorites;
